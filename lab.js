...
favoriteThings['show'] = 'The man who fell to Earth'
...
const totalPopulation = obj => Object.values(obj).reduce((a, b) => a + b);
...
const {carb, fat, protien} = object1;
...
console.log(ingredients({object1}));
...
const cat1 = new Cat("Meowser", 12, "Purple");
...
let wizard1 = new Wizard("Harry Gandalf", 765, "Magical Kinesis");
wizard1.castSpell();
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
const phone1 = new Phone("Apple", "Iphone 4", 256, "Purple", 800);
const phone2 = new Phone("Samsung", "Galaxy S10", 1000, "Space Purple", 200);
const phone3 = new Phone("Apple", "Iphone 10", 512, "Deep Purple", 1200);
/* 
...
//Code Here
const myFirstVehicle = new Vehicle(8, "Purple", 20000);
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, "Green", 10000, "Honda", true)
/*
...
//Code Here
const myFirstBoat = new Boat(12, "Blue-ish", 14500, "Jumanji with Lasers", "Catamaran", false);
/*
